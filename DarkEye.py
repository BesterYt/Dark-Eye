...
╚═════╝  ╚═╝  ╚═╝ ╚═╝ ╚═╝  ╚═╝  ╚═╝     ╚══════╝    ╚═╝     ╚══════╝
            ...
            Creator: @Dark_eye_watching
              For Dark Eye team

╔================================================╗
║ [1] Account destroy   [2] Channel destroy      ║
║                                                ║
║ [3] Bot destroy       [4] Chat destroy         ║
║                                                ║
║                                                ║
║   Please, use only for reporting bad users!    ║
║                                                ║                                  
╚================================================╝
'''
...
banner = Colorate.Horizontal(Colors.red_to_white, alignment)
print(banner)
...
def main():
    ...
    if choice == '1':
        ...
        print("12. РАСПР0СТР0НЯЕТ ПОРНОГРАФИЮ")
        print("13. СУТЕНЕР(ПР0СТИТУЦИЯ)")
        ...
        print("3. С ДЕТСК0Й П0РНОГРАФИЕЙ")
